...
/* package randomart-0.1.0.0 */
#ifndef VERSION_randomart
#define VERSION_randomart "0.1.0.0"
#endif /* VERSION_randomart */
#ifndef MIN_VERSION_randomart
#define MIN_VERSION_randomart(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_randomart */
...
#define CURRENT_COMPONENT_ID "randomart-0.1.0.0-inplace-randomart"
